...
public class Other_out_storageController {
    ...
    public Other_out_storage selectByPrimaryKey(String oosId) {
		System.out.println("进入Other_out_storageController根据主键查询");
		System.out.println("oosId="+oosId);
	...
	@ResponseBody
    public Map<String, String> insertSelective(@RequestBody Other_out_storage record) {
		System.out.println("进入Other_out_storageController新增");
	...
	@ResponseBody
    public Map<String, String> updateByPrimaryKeySelective(@RequestBody Other_out_storage record) {
		System.out.println("进入Other_out_storageController根据主键修改");
		System.out.println("实体："+record.toString());
		Map<String, String> map=new HashMap<String, String>();
	...
	@ResponseBody
    public Map<String, String> deleteByPrimaryKey(String oosId,Model model) {
		System.out.println("进入Other_out_storageController根据主键删除");
		System.out.println("oosId："+oosId);
		Map<String, String> map=new HashMap<String,String>();
    	int i =dao.deleteByPrimaryKey(oosId);
		if (i>0) {
			map.put("code", "1");

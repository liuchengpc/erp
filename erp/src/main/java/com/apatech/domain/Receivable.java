...
public class Receivable {
	...
	public String toString() {
		return "Receivable [receivableId=" + receivableId + ", customerId=" + customerId + ", scsId=" + scsId
				+ ", staffId=" + staffId + ", currencyId=" + currencyId + ", projectId=" + projectId + ", customerName="
				+ customerName + ", payablesSatName1=" + payablesSatName1 + ", payablesPrice1=" + payablesPrice1
				...
				+ ", payablesAuditstatus=" + payablesAuditstatus + ", payablesAuditstatusAuditing="
				+ payablesAuditstatusAuditing + ", payablesAuditstatusYn=" + payablesAuditstatusYn
				+ ", payablesCustom1=" + payablesCustom1 + ", payablesCustom2=" + payablesCustom2 + ", payablesCustom3="
				+ payablesCustom3 + ", payablesCustom4=" + payablesCustom4 + ", payablesCustom5=" + payablesCustom5
				+ ", payablesCustom6=" + payablesCustom6 + ", payablesCustom7=" + payablesCustom7 + ", payablesCustom8="
				+ payablesCustom8 + ", payablesCustom9=" + payablesCustom9 + ", payablesCustom10=" + payablesCustom10
				+ "]";
	}
    ...
    public void setPayablesAuditstatusAuditing(String payablesAuditstatusAuditing) {
        this.payablesAuditstatusAuditing = payablesAuditstatusAuditing == null ? null : payablesAuditstatusAuditing.trim();
    }
    ...
    public void setPayablesAuditstatusYn(String payablesAuditstatusYn) {
        this.payablesAuditstatusYn = payablesAuditstatusYn == null ? null : payablesAuditstatusYn.trim();
    }
    ...
    public void setPayablesCustom9(String payablesCustom9) {
        this.payablesCustom9 = payablesCustom9 == null ? null : payablesCustom9.trim();
    }

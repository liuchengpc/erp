...
public class wd_Adjust_detail {
	...
	public String toString() {
		return "wd_Adjust_detail [apId=" + apId + ", apDateid=" + apDateid + ", apCustom6=" + apCustom6 + ", upName="
				+ upName + ", upCustom6=" + upCustom6 + ", mmatterName=" + mmatterName + ", matterId=" + matterId
				+ ", muName=" + muName + ", mmatterSize=" + mmatterSize + ", mmatterNowcount=" + mmatterNowcount
				+ ", mmatterNowavgcost=" + mmatterNowavgcost + ", mmonePrice=" + mmonePrice + ", dAdjustprice="
				+ dAdjustprice + ", dDecoration=" + dDecoration + ", apDoworkman=" + apDoworkman + ", apRecheckman="
				+ apRecheckman + ", dApid=" + dApid + ", dMatterid=" + dMatterid + ", updowmid=" + updowmid + ", apYn="
				+ apYn + ", upId=" + upId + ", upCustom5=" + upCustom5 + ", mamuId=" + mamuId + ", myamuId=" + myamuId
				+ "]";
	}
	public wd_Adjust_detail() {
		super();
	}

...
CREATE TABLE `account` (
  ...
  `account_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `bank` (
  ...
  `bank_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `bank_deposit_account` (
  ...
  `ada_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `bank_type` (
  ...
  `bt_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `casha_ccount` (
  ...
  `cc_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `check` (
  ...
  `check_documentation_date` varchar(32) DEFAULT NULL,
  `check_documentation_no` datetime DEFAULT NULL,
  ...
  `check_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `collection_term` (
  ...
  `cote_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `currency` (
  ...
  `urrency_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `customer` (
  ...
  `customer_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `customer_address` (
  ...
  `ca_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `customer_demand_products` (
  ...
  `cdp_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `customer_grade` (
  ...
  `cg_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `customer_type` (
  ...
  `cuty_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `educational_background` (
  ...
  `eb_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `income_costs_type` (
  ...
  `ict_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `input_storage_type` (
  ...
  `ist_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `invoice_type` (
  ...
  `it_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `invoicetype` (
  `invoicetype_id` varchar(50) NOT NULL COMMENT '发票类型id（主键 唯一）',
  `invoicetype_name` varchar(50) DEFAULT NULL COMMENT '发票类型名称',
  `invoicetype_engname` varchar(50) DEFAULT NULL COMMENT '英文名称',
  `invoicetype_remarks` varchar(50) DEFAULT NULL COMMENT '备注',
  `invoicetype_Auditing` varchar(50) DEFAULT NULL COMMENT '是否审核',
  `invoicetype_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
  `invoicetype_custom1` varchar(50) DEFAULT NULL COMMENT '自定栏一',
  `invoicetype_custom2` varchar(50) DEFAULT NULL COMMENT '自定栏二',
  `invoicetype_custom3` varchar(50) DEFAULT NULL COMMENT '自定栏三',
  `invoicetype_custom4` varchar(50) DEFAULT NULL COMMENT '自定栏四',
  `invoicetype_custom5` varchar(50) DEFAULT NULL COMMENT '自定栏五',
  `invoicetype_custom6` varchar(50) DEFAULT NULL COMMENT '自定栏六',
...
CREATE TABLE `material_type` (
  ...
  `mt_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `matter` (
  ...
  `matter_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `measurement_unit` (
  ...
  `mu_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `moneybelong` (
  ...
  `moneybelong_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `negotiation_stage` (
  ...
  `ns_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `other_input_storage` (
  ...
  `ois_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `other_input_storage_detailed` (
  ...
  `oisd_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `other_out_storage` (
  ...
  `oos_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `other_out_storage_detailed` (
  ...
  `oosd_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `out_storage_type` (
  ...
  `ost_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `payables` (
  ...
  `payables_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `payables_detail` (
  ...
  `pade_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `potential_customer` (
  ...
  `pc_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `priabill` (
  ...
  `priabill_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `project` (
  ...
  `project_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `purchase_returns_detailed` (
  ...
  `pured_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `purchase_storage_detailed` (
  ...
  `psd_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `receivable` (
  ...
  `payables_auditstatus_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `receivablesdetails` (
  ...
  `recedetail_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `referpria` (
  ...
  `Referpria_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `referrece` (
  ...
  `referrece_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `requisition` (
  ...
  `requisition_documentation_date` varchar(32) DEFAULT NULL,
  `requisition_documentation_no` datetime DEFAULT NULL,
  ...
  `requisition_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `sales_order_type` (
  ...
  `sot_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `sales_out_warehouse` (
  ...
  `sow_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `sales_out_warehouse_detailed` (
  ...
  `sowd_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `sales_quotation_details` (
  `sqd_id` varchar(50) NOT NULL,
  `sqd_document_time` date DEFAULT NULL,
  `sqd_documentnumber` varchar(20) DEFAULT NULL,
  `sqd_delivery_address` varchar(20) DEFAULT NULL,
  `sot_id` varchar(50) DEFAULT NULL,
  `sqd_customerorder` varchar(50) DEFAULT NULL,
  `sqd_tax` int(11) DEFAULT NULL,
  `currency_id` varchar(50) DEFAULT NULL,
  `sqd_oder_static` int(11) DEFAULT NULL,
  `staff_id` varchar(50) DEFAULT NULL,
  `team_id` varchar(50) DEFAULT NULL,
  `sqd_monograph` varchar(50) DEFAULT NULL,
  `sqd_reviewer` varchar(50) DEFAULT NULL,
  `sqd_ subordinate` varchar(20) DEFAULT NULL,
  `sqd_ watchword` varchar(20) DEFAULT NULL,
  `sqd_ tailclause` varchar(20) DEFAULT NULL,
  `sqd_ remark` varchar(200) DEFAULT NULL,
  `sqd_account_ownership` varchar(30) DEFAULT NULL,
  `sqd_collection_time` date DEFAULT NULL,
  `sqd_collection_month` date DEFAULT NULL,
  `sqd_collection_terms` varchar(20) DEFAULT NULL,
  `sqd_collection_terms_day` varchar(50) DEFAULT NULL,
  `sqd_auditing` varchar(50) DEFAULT NULL,
  `sqd_yn` varchar(50) DEFAULT NULL,
  ...
  `sqd_custom6` varchar(0) DEFAULT NULL,
  PRIMARY KEY (`sqd_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `salesorderlist` (
  ...
  `sol_yn` varchar(50) DEFAULT NULL,
...
CREATE TABLE `settle_accounts_type` (
  ...
  `sat_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `staff` (
  ...
  `staff_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `subject_blanket_category` (
  ...
  `sbc_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `subject_category` (
  ...
  `sc_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `supplier` (
  ...
  `supplier_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `supplier_type` (
  ...
  `st_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `tax_items` (
  ...
  `ti_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `warehouse` (
  ...
  `warehouse_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `warehouse_detail` (
  ...
  `wd_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',
...
CREATE TABLE `zone` (
  ...
  `zone_yn` varchar(50) DEFAULT NULL COMMENT '是否删除（0 否 1 是 ，默认0）',

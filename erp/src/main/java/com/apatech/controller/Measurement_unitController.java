...
public class Measurement_unitController {
    ...
    public Measurement_unit selectByPrimaryKey(String muId) {
		System.out.println("进入Measurement_unitController根据主键查询");
	...
	@ResponseBody
    public Map<String, String> insertSelective(@RequestBody Measurement_unit record) {
		System.out.println("进入Measurement_unitController新增");
	...
	@ResponseBody
    public Map<String, String> updateByPrimaryKeySelective(@RequestBody Measurement_unit record) {
		System.out.println("进入Measurement_unitController根据主键修改");
		System.out.println("实体："+record.toString());
		Map<String, String> map=new HashMap<String, String>();
	...
	@ResponseBody
    public Map<String, String> deleteByPrimaryKey(String muId,Model model) {
		System.out.println("进入Measurement_unitController根据主键删除");
		System.out.println("muId："+muId);
		Map<String, String> map=new HashMap<String,String>();
    	int i =dao.deleteByPrimaryKey(muId);
		if (i>0) {
			map.put("code", "1");
